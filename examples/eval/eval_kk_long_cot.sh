...
RUN_NAME="eval_kk_long_cot"

MODEL_NAME="verl-server-1-kk-long-3/global_step_125/actor/huggingface"
DATA_PATH="data/KK-Data/RL_qwen_eval/eval.parquet"
PROMPT_KEY=prompt
