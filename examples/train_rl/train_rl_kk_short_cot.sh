...
export RUN_NAME='train_rl_kk_short_cot'
...
export MODEL_NAME="global_step_14"
...
export ROLLOUT_GPU_MEMORY_UTIL=0.85
...
export HDFS_MODEL_PATH='checkpoints/sft-server1-kk-short-1'
