...
export RUN_NAME='train_rl_kk_re_distill_rl'
...
export log_prob_max_token_len_per_gpu=150000

export vllm_max_num_seqs=256

export REMOVE_PREVIOUS_CKPT=True

export MODEL_NAME="global_step_62"
...
export HDFS_MODEL_PATH='checkpoints/sft-server1-kk-actor-cot-2'
